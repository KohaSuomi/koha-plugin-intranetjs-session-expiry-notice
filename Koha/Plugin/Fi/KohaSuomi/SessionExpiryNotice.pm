package Koha::Plugin::Fi::KohaSuomi::SessionExpiryNotice;
...
sub intranet_js {
    ...
    my $plugin_fulldir = $dir . "/Koha/Plugin/Fi/KohaSuomi/SessionExpiryNotice/";
    my $js = read_file($plugin_fulldir .'script.js');
    
    my $param_a = $self->retrieve_data('config_param_a') || 1800;
...
sub configure {
    ...
    unless ( $cgi->param('save') ) {
        ...
        $template->param(
            config_param_a => $self->retrieve_data('config_param_a') || 1800,
